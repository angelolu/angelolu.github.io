...
After experimenting with different sizes and shapes, printing on my Monoprice Maker Select Plus in Seacans PLA, I created, at the request of my housemates, a cat shaped cookie cutter designed so it would emboss the cookie with our cat's name. After baking a batch of cookies and jokingly posting a picture of the cookies and the cutter to Snapchat, I was surprised when several friends reached out and asked me if I would make them ones with their own pet's names. Some even mentioned they would pay me!
...
1. Draw/scan the design that you want, or download a picture online. If drawing, using a thicker marker (such as a Sharpie) can make lines easier to trace later on.
...
7. If your cutter is large or has disconnected elements, draw bars across empty space to connect the peices and make the cutter more rigid and durable.
    * I made my connecting bars 4 mm in width
8. Extrude the sketch. I've included a diagram below for my extrusion depths.
